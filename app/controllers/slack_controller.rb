...
def exclude_seffy
  puts slack_params[:user_id].to_s.strip!
  puts Rails.application.secrets.seffy_user_id.to_s.strip!
  verified_is_seffy = slack_params[:user_id].to_s.strip! == Rails.application.secrets.seffy_user_id.to_s.strip!
